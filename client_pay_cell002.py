"""
Ligeia Studio — Cell 002 Live Paid Test (Geometric Measurement Engine)
Target: https://cell001-media-geometry.ligeiastudio-aitools.workers.dev/v1/geometry/measurement
...
ENDPOINT_URL = "https://cell001-media-geometry.ligeiastudio-aitools.workers.dev/v1/geometry/measurement"
...
def main():
    print_section("CELL 002: LIVE ON-CHAIN PAID TEST (/v1/geometry/measurement)")
    ...
    if resp_paid.status_code == 200:
        print("\n[✓] SUCCESS! CELL 002 LIVE CALCULATION DELIVERED:")
        print("=" * 65)
        print(json.dumps(resp_paid.json(), indent=2))
        print("=" * 65)
        print("[PASS] Cell 002 (Geometric Measurement) Verified Live on Cloudflare Edge!")
    else:
